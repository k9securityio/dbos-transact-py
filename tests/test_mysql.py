...
def test_nonserializable_values(dbos_mysql: DBOS) -> None:
    # copied from test_dbos::test_nonserializable_values
...
def test_debug_logging(dbos_mysql: DBOS, caplog: pytest.LogCaptureFixture) -> None:
    # copied from test_dbos::test_debug_logging
    dbos: DBOS = dbos_mysql
...
def test_recovery_appversion(config_mysql: ConfigFile) -> None:
    # copied from test_dbos::test_recovery_appversion
